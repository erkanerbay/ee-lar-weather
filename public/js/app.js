...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    fetch: function fetch(url, params) {
      ...
      return this.axios.get('/weather/status', {
        params: params
      }).then(function (_ref) {
        var data = _ref.data;
        return data;
    ...
    fetchStates: function fetchStates() {
      ...
      this.axios.get('/weather/states').then(function (_ref2) {
        var data = _ref2.data;
        _this2.states = data;
      })["catch"](function (err) {
        var _err$response2;
    ...
    fetchCurrent: function fetchCurrent(state) {
      ...
      this.axios.get('/weather/status', {
        ...
        _this3.errors = err === null || err === void 0 ? void 0 : (_err$response3 = err.response) === null || _err$response3 === void 0 ? void 0 : _err$response3.data;
      });
    },
    fetchForecasts: function fetchForecasts(state) {
      var _this4 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _this4.fetch('/weather/status', params);

              case 3:
                data = _context.sent;
                _this4.forecasts = data;
      ...
      _vm.forecasts
        ? _c("div", { staticStyle: { "overflow-x": "scroll" } }, [
            _c(
              ...
              _vm._l(_vm.forecasts, function(forecast) {
                return _c(
                  "card",
                  { staticClass: "mx-3", staticStyle: { width: "360px" } },
                  [_c("weather", { attrs: { data: forecast } })],
                  1
                )
              }),
              1
    ...
    _c(
      ...
      _vm._l(_vm.keys, function(key) {
        return _c(
          ...
          { key: key },
          [
            typeof _vm.data[key] !== "undefined"
              ? [
                  _c("td", {
                    domProps: { textContent: _vm._s(_vm.getName(key)) }
                  }),
                  _vm._v(" "),
                  _c("td", { domProps: { textContent: _vm._s(_vm.data[key]) } })
                ]
              : _vm._e()
          ],
          2
